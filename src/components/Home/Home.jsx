...
const Home = () => {
  return (
    ...
    <Steps />
    <section className='bg-[#6869FF] mb-24 rounded-2xl mx-10 relative flex py-16 justify-center items-center flex-col'>
      <img src={zigzag} className='absolute top-0 right-0 left-0 bottom-0' alt="" />
<h2 className='font-medium text-4xl text-white'>Don’t miss out!</h2>
<p className='text-[#ffffffcc] text-base font-normal mt-2 mb-8'>Sign up to join the waiting list and be the first to know when we launch</p>
